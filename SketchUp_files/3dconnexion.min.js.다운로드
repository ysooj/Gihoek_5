...
_3Dconnexion.prototype.onEvent = function (n, t) {
  ...
  if (
    ...
    t[0] === window.ab._MESSAGE_TYPEID_CALL)
  ) {
    if (t[2] === 'self:read')
...
_3Dconnexion.prototype.update3dcontroller = function (n) {
  ...
  try {
    if (!t._3dcontroller)
      throw 'exception 3dx_rpc:update: 3dcontroller not initialized';
    t.session
    ...
    if (n.status === 100)
      ++t.outstanding_requests,
        (n.onload = function () {
          ...
          n.onload = function () {};
          n.status !== 200 &&
            ((i = t.images.indexOf(n)), i > -1 && t.images.splice(i, 1));
          --t.outstanding_requests;
      ...
      u = (r.Base64 = {
        ...
        parse: function (n) {
          var o = n.length,
            ...
            c;
          for (
            s && ((f = n.indexOf(s)), f != -1 && (o = f)), e = [], r = 0, t = 0;
            t < o;
            t++
          )
            t % 4 &&
